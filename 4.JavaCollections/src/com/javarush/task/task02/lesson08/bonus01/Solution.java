...
public class Solution {
    ...
    private <T extends Item> T getProxy(Class<T> tClass, Class<?>... classes) {
        ...
        Item item = (Item) Proxy.newProxyInstance(tClass.getClassLoader(),interfaces, new ItemInvocationHandler());
        return (T)item;
    }
